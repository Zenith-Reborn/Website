...
export const metadata: Metadata = {
  ...
  description: 'Transform your skills with SkillQuest - the premium skill mastery and focus tracking app. Track progress, master skills, and rise to excellence.',
  ...
  openGraph: {
    title: 'Zenith Reborn - Rise to Your Potential',
    description: 'Transform your skills with SkillQuest - the premium skill mastery and focus tracking app.',
