...
✅ **Zen Focus unlock** → Immediately visible in UI
✅ **Inferno Master unlock** → 10→11 themes, instant update
✅ **Theme selection** → Works without crashes
✅ **Dark mode switching** → Correct theme per mode
✅ **App restart** → State remains consistent
