            ...
            <div className="border-primary-gold/20 border-t pt-8">
              ...
              <div className="flex gap-4">
                <a
                  ...
                  className="bg-neutral-darkBg border-primary-gold/30 hover:border-primary-gold hover:bg-primary-gold/10 flex h-12 w-12 items-center justify-center rounded-full border transition-all hover:scale-110"
                ...
                <a
                  ...
                  aria-label="Facebook"
                >
                  <svg className="h-6 w-6 fill-current text-neutral-lightText" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
