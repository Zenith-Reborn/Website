          ...
          <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
            ...
            <div className="flex gap-4">
              <a
                ...
                className="bg-neutral-darkBg border-primary-gold/30 hover:border-primary-gold hover:bg-primary-gold/10 flex h-10 w-10 items-center justify-center rounded-full border transition-all hover:scale-110"
                aria-label="Twitter / X"
              >
                <svg className="h-4 w-4 fill-current text-neutral-lightText" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <a
                ...
                aria-label="Facebook"
              >
                <svg className="h-5 w-5 fill-current text-neutral-lightText" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
